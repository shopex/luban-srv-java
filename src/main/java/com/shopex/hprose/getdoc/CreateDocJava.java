...
public class CreateDocJava {
	static final String injavapath="src/main/java/com/shopex/hprose/server";
	static final String outdocfile="src/main/java/com/shopex/hprose/getdoc/Doc.java";
	...
	private static void createDoc(){
		...
		sb.append("package com.shopex.hprose.getdoc;\n");
		...
		sb.append("static final String doc = "+getmapstr()+";\n");
		sb.append("static HashMap hm = null;\n");
		sb.append("public static HashMap getdoc(){\n");
		sb.append("try {\n");
		...
		sb.append("System.out.println(getdoc());\n");
		sb.append("}\n");
		sb.append("}\n");
	...
	private static HashMap  getdoc(){
		...
		try {
			...
			for(String file: files){
				...
				lines = Files.readAllLines(Paths.get("src/main/java/com/shopex/hprose/server/"+file), Charset.forName("UTF-8"));
